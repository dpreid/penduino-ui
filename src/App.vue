<template>
  ...
  <div class='row' id='component-grid'>
      ...
      <div class='col-lg-6 col-sm-12' id='left-screen'>
        ...
        <div class='col drop-area' id='drop_3_0' :draggable='getDraggable' @dragstart="dragComponent" @drop='dropComponent' @dragover.prevent @dragenter.prevent><user-input id='user-input' /></div>
      ...
      <div class='col-lg-6 col-sm-12' id='right-screen'>
        ...
        <div class='col drop-area' id='drop_1_1' :draggable='getDraggable' @dragstart="dragComponent" @drop='dropComponent' @dragover.prevent @dragenter.prevent><stopwatch v-if='isStopwatchOn' id='stopwatch'/></div>
